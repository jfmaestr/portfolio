...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4135f5d4c7f501e3b4107e35225733a8637ef7092db96a7870c3203a470ca526.js',function(){input.required=false;search();});}
